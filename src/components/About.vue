  ...
  <div class="uk-container uk-margin-top">
    ...
    <div class="uk-flex uk-flex-center@m uk-flex-right@l">
      <div class>
        <a
          target="_blank"
          href="https://twitter.com/BenounnasOuss  "
          uk-icon="icon: twitter; ratio:4"
        ></a>
      </div>
      <div class="uk-margin-left">
        <a target="_blank" href="https://github.com/0usssama" uk-icon="icon: github; ratio:4"></a>
      </div>
      <div class="uk-margin-left">
        <a
          target="_blank"
          href="mailto:benounnas.oussama@protonmail.com"
          uk-icon="icon: mail; ratio:4"
        ></a>
      </div>
    </div>
    <a
